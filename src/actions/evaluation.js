...
export const postAnswer = (_id, comment_id, answer, socket) => (dispatch) => {
...
export const deleteAnswer = (_id, comment_id, answer_id, socket) => (dispatch) => {
...
export const likeComment = (_id, comment_id, socket) => (dispatch) => {
...
export const unlikeComment = (_id, comment_id, socket) => (dispatch) => {
